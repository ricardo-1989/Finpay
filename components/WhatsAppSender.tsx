            ...
            <div className="lg:col-span-7 flex flex-col gap-6">
               ...
               <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                  {templates.map(tpl => (
                     <button
                        ...
                        className={`p-4 rounded-xl border flex flex-col items-center gap-2 transition-all group ${activeTemplate === tpl.id
               ...
               <div className="bg-white dark:bg-slate-800 rounded-3xl p-6 shadow-sm border border-slate-200 dark:border-slate-700">
                  <div className="flex items-start justify-between mb-5">
                     ...
                     <div className={`flex items-center gap-1.5 px-3 py-1 rounded-full border ${client.status === 'Atrasado' ? 'bg-rose-500/10 border-rose-500/20 text-rose-500' :
                        client.status === 'Pago' ? 'bg-emerald-500/10 border-emerald-500/20 text-emerald-500' :
                           'bg-orange-500/10 border-orange-500/20 text-orange-600'
                        }`}>
                        <div className={`size-2 rounded-full animate-pulse ${client.status === 'Atrasado' ? 'bg-rose-500' :
               ...
               <div className="bg-white dark:bg-slate-800 rounded-3xl p-8 shadow-sm border border-slate-200 dark:border-slate-700 space-y-8">
                  ...
                  <div className="pt-4 border-t border-slate-100 dark:border-slate-700/50">
                     ...
                     <div
                        ...
                        className={`relative group h-24 border-2 border-dashed rounded-2xl flex flex-col items-center justify-center cursor-pointer transition-all ${attachedFile
